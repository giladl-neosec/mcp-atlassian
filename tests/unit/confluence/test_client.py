...
def test_init_with_mtls_auth_uses_effective_api_url():
    ...
    config = ConfluenceConfig(
        url="https://collaborate.akamai.com/confluence",
        api_url="https://api.collaborate.akamai.com/confluence/rest/api",
        auth_type="mtls",
    ...
    with (
        ...
        mock_confluence.assert_called_once_with(
            url="https://api.collaborate.akamai.com/confluence",
